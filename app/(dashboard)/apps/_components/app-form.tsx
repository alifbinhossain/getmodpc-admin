        ...
        <FormWrapper>
          <div className='flex flex-col md:flex-row gap-5'>
            ...
            <div className='w-full md:flex-1 space-y-5'>
              <AccordionContainer title='Platform Information' value='platform'>
                <div className='space-y-5'>
                  ...
                  <FormSelect
                    ...
                    options={Object.values(EnumAppCommentStatus).map(
                      (value) => ({
                        label: value,
                        value,
                      })
              ...
              <MultiInputField
                ...
                form={form}
              />
              <AccordionContainer title='Verified' value='verified'>
                <FormCheckbox
                  showLabel={false}
                  control={control}
                  name='is_verified'
                  label='Mark this app as verified'
                />
                <span className='text-sm text-muted-foreground mt-5 inline-block'>
                  When checked, a verified badge will appear next to the app
                  title everywhere it is displayed.
                </span>
              </AccordionContainer>
              <AccordionContainer title='Platform Slider' value='slider'>
                <FormCheckbox
                  showLabel={false}
                  control={control}
                  name='show_in_slider'
                ...
                />
                <span className='text-sm text-muted-foreground mt-5 inline-block'>
                  Check to feature this app in the top slider on its platform
                  page.
                </span>
              </AccordionContainer>
            </div>
